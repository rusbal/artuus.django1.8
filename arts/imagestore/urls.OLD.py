...
from .views import (
    # AlbumListView, ImageListView, UpdateImage, \
    # UpdateAlbum, CreateImage, CreateAlbum, \
    # DeleteImage, DeleteAlbum, ImageView,

    featured_page, album_page
)


urlpatterns = patterns('imagestore.views',
                       url(r'^$', featured_page, name='featured_page'),
                       url(r'^works/$', album_page, name='album_page'),
#
#                        url(r'^album/$', AlbumListView.as_view(), name='index'),
#
